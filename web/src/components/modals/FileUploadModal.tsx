...
import {useFloatingUploadCard} from "@/providers/FloatingUploadCardProvider.tsx";
...
const FileUploadModal = ({isOpen, onClose}: Props) => {
    const [files, setFiles] = useState<File[] | null>(null);
    const {openCard} = useFloatingUploadCard();
