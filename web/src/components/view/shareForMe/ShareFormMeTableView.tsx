...
type ShareFormMeTableViewProps = {
    files: FileData[];
    path: string;
};

export const ShareFormMeTableView: React.FC<ShareFormMeTableViewProps> = ({files, path}) => {
            ...
            <Table>
                ...
                <TableBody>
                    {files.map((item, index) => (
                        <ShareForeMeFileContextMenu file={item} key={index}>
                            <TableRow
